...
async function startMetro(expoPublicDomain, expoPublicReplId) {
  ...
  if (clerkKey) {
    console.log('Setting EXPO_PUBLIC_CLERK_PUBLISHABLE_KEY (from env)');
  } else {
    console.warn(
      'WARNING: EXPO_PUBLIC_CLERK_PUBLISHABLE_KEY is not set — authentication will not work in production builds.',
    );
  }
